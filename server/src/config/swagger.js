    ...
    components: {
      securitySchemes: {
        bearerAuth: {
          ...
          bearerFormat: "JWT",
          description:
            'Paste the JWT returned by /api/auth/login (without the "Bearer " prefix).',
        },
      },
      ...
      schemas: {
        ...
        Asset: {
          ...
          properties: {
            ...
            asset_tag: {
              type: "string",
              description: "Auto-generated (AST-<id>), not admin-supplied",
            },
            name: {
              type: "string",
              description: 'Derived: "<brand> <category> #<id>"',
            },
