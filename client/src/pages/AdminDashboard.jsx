...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <p className="mb-8 text-sm text-zinc-500">Here's what you can manage today.</p>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="mt-1 text-sm text-zinc-500">View, search, and manage employee accounts</p>
        </Link>
        ...
        >
          ...
          <p className="mt-1 text-sm text-zinc-500">Create and manage departments</p>
        </Link>
      </div>
    </div>
  );
