...
export default function RequestAsset() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (
        requestType === "asset" &&
        typeof result.available_count === "number"
      ) {
        message =
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mb-6 text-base text-zinc-500">
        Request a new asset, or a return/repair for one already assigned to you.
      </p>
      ...
      >
          ...
          <div>
            ...
            {myAssets.length === 0 && (
              <p className="mt-1.5 text-sm text-zinc-500">
                You have no assets currently assigned to you.
              </p>
            )}
          </div>
        )}
        ...
        <button
          type="submit"
          disabled={
            submitting || (requestType !== "asset" && myAssets.length === 0)
          }
