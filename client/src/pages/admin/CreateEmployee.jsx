...
export default function CreateEmployee() {
  ...
  return (
    <div className="max-w-md">
      ...
      <p className="mb-6 text-sm text-zinc-500">Create an account and share the temporary password.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-zinc-800 bg-zinc-900/60 p-6 shadow-sm">
        ...
        <div>
          <label className="mb-1.5 block text-sm font-medium text-zinc-300">Temporary password</label>
          <input
            type="text"
            ...
            className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm text-zinc-100 transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
          />
          <p className="mt-1.5 text-xs text-zinc-500">Share this with the employee securely — it won't be shown again.</p>
        </div>
